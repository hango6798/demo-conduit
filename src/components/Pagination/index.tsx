...
export const Pagination = ({
  ...
  return pagesCount > 1 ? (
    <PagiBootstrap className="d-flex justify-content-center mt-3">
      <PagiBootstrap.First
      ...
      />
      {currentPage > 3 && (
        <PagiBootstrap.Item onClick={() => setCurrentPage(1)}>
          {1}
        </PagiBootstrap.Item>
      )}
      {currentPage > 4 && (
      ...
      {currentPage > 1 && (
        <PagiBootstrap.Item onClick={() => setCurrentPage(currentPage - 1)}>
          {currentPage - 1}
        </PagiBootstrap.Item>
      )}
      ...
      {currentPage < pagesCount && (
        <PagiBootstrap.Item onClick={() => setCurrentPage(pagesCount)}>
          {pagesCount}
        </PagiBootstrap.Item>
      )}
      <PagiBootstrap.Next
